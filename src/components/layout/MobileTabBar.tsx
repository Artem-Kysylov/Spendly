...
import { CreditCard, LayoutDashboard, Plus, Wallet } from "lucide-react";
          ...
          <ul className="h-20 grid grid-cols-5 grid-rows-1 items-stretch pt-1 pb-2">
            ...
            <li className="flex items-center justify-center">
              <div className="flex flex-col items-center justify-center gap-0.5">
                <button
                  ...
                  className="w-12 h-12 rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/30 md:hover:bg-primary/90 transition-all duration-200 border-2 border-white dark:border-card flex items-center justify-center"
                >
            ...
            <li className="flex items-center justify-center">
              <button
                ...
                className="flex flex-col items-center justify-center h-full w-full gap-0.5 md:hover:opacity-90 transition-opacity"
              >
