...
export function TransactionChatWindow({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    const { session } = UserAuth()
    const { toast } = useToast()
    const tAI = useTranslations('assistant')
    const { messages, input, setInput, handleSubmit, isLoading, stop } = useTransactionChat()
            ...
            <div className="bg-background text-foreground flex flex-col relative h-full">
                ...
                <SheetHeader>
                    <div className="flex items-center gap-2">
                        ...
                        <SheetTitle id="transaction-chat-title">💰 Add Transaction</SheetTitle>
                    </div>
                    <SheetClose
                        ...
                        {messages.length === 0 ? (
                            <div className="p-4 text-center">
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                                    Describe your transaction in natural language and I'll help you add it.
                                </p>
