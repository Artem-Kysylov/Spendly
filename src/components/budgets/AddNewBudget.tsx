...
const NewBudget = ({ onClick }: { onClick: () => void }) => {
  return (
    <div
      onClick={onClick}
      className="flex flex-col items-center justify-center gap-[8px] border border-primary rounded-lg cursor-pointer w-[335px] min-w-[335px] h-[200px] bg-white transition-colors duration-300 hover:bg-primary group"
    >
