...
const BudgetFolderItem = ({ id, emoji, name, amount }: BudgetFolderItemProps) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-[8px] border border-light-grey rounded-lg w-[335px] min-w-[335px] h-[200px] bg-white transition-opacity duration-300 hover:opacity-50">
      ...
      <div className="w-[280px] flex flex-col gap-1">
        <Progress value={spentAmount} max={amount} className="h-2" />
