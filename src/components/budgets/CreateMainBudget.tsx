...
const CreateMainBudget = ({ onSubmit }: CreateMainBudgetProps) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-5 w-[630px]">
            ...
            <h2 className="text-[35px] font-semibold text-secondary-black">Let`s create your monthly budget</h2>
            ...
            <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
                <DialogContent>
                    ...
                    <DialogFooter>
                        <DialogClose className="px-4 py-2 rounded-md border">Cancel</DialogClose>
                        <button
